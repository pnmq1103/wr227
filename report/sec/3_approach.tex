...
Following RALA \cite{fan2025breaking}, we use the Hadamard transformation to fix the low rank problem of the linear attention:
\begin{equation}
  \phi(X) = \sigma(HX)
\end{equation}
