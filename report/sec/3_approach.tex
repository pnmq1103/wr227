...
To enable continuous down-weighting of uninformative features, we model the swarm's policy $\pi_\theta(a_{n,l} \mid s_{n,l})$ as a \textbf{Squashed Gaussian} distribution. This approach avoids the non-differentiability of discrete gating and the competitive constraints of global Softmax operations, allowing each agent to determine its survival weight independently.
