...
Our evaluation includes two primary computer vision tasks: \textbf{image classification} and \textbf{object detection}. We focus on measuring the trade-off between model accuracy and computational efficiency (both training and inference) while conducting ablation studies to isolate the impact of each architectural component.
...
\begin{itemize}
  \item object detection: RALA, Ours, RMT-T
  \item image classification: RALA, Ours, MLLA-T
  \item inference speed
  \item ablation study: softmax, linear, non RL
\end{itemize}
