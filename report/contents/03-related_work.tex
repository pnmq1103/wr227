...
Linear Attention fix the quadratic complexity of Softmax attention by using kernel functions to approximate the \(Sim()\) operator, reducing the complexity to linear. However, its performance is still largely behind softmax. Many  
