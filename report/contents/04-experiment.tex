\section{Experiments}
We will analyze our architecture with different computer vision tasks, and compare
the to other standard Vision Transformers model, with repsect to the speed(FLOPs) and accuracy.
