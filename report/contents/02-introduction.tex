...
SGG has a wide range of applications, namely, image captioning \cite{nguyen2021defense,gao2018image}, visual question answering \cite{johnson2017inferring} (VQA), image retrieval \cite{johnson2015image}, and image generation \cite{ashual2019specifying,johnson2018image}. However, real-world scenarios are diverse and contain unseen objects and relationships. Open-vocabulary Scene Graph Generation (Ov-SGG) addresses this challenge by leveraging large-scale models, e.g., Multimodal Large Language Models (MLLMs) and Vision-Language Models (VLMs). Despite these advances, object identification in open-vocabulary settings remains incomplete.

\subsubsection{Research Scope.} In this study, we address the problem of SGG strictly within the domain of static 2D images, excluding video or 3D point cloud data.
